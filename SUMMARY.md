...
* [How to install FF](install-instructions.md)
* [How to update FF](update-instructions.md)
* [How to add mods to FF](adding-more-mods.md)
* [How to remove mods from FF](disabling-mods.md)
* [How to backup and uninstall FF](backup-and-uninstall.md)
